# Синтез теории управления древа состояний данных сессий пользователя
...
[State Action Model](https://habr.com/ru/post/277113/) и MobX State Tree наиболее похожие на наш инструмент решения управления состоянием.

На следующей неделе о том как появился инструмент поощряющий приготовление лапши из любых видов связей, со вкусом истинного MVC либо вкуснейшего MobX.
